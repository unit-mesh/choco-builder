...
-------------------------------------------------------------------------------"""
    ...
    @Test
    fun should_handle_for_two_component() {
        val dsl = """pageName: 博客发表页
...
--------------------------------------"""
        ...
        val design = DesignDsl().analysis(dsl)
        design.layouts.size shouldBe 2
    }

    @Test
    fun should_handle_to_multiple_grid() {
        val dsl = """pageName: 商品订单详细
usedComponents: Grid, Box, Typography, TextField, Button, Pagination
