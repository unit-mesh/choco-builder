...
class CodeReviewCommand : CliktCommand(help = "Code Review with AIGC") {
    ...
    private val sinceCommit by option(help = "Begin commit revision").default("HEAD")
    private val untilCommit by option(help = "End commit revision. Aka latest").default("HEAD")
